...
public interface User_dao {
    ...
    @Update("update addressbook..user1  + set name=#{name},birth=#{birth},profession=#{profession},"+
            "className=#{className},entranceTime=#{entranceTime},leaveTime=#{leaveTime},employmentUnit=#{employmentUnit}," +
            "location=#{location},phoneNumber=#{phoneNumber},email=#{email},description=#{description} where userName=#{userName}")
    Boolean setUserByUserName(@Param("userName") String userName, @Param("name") String name, @Param("birth") String birth,
                              @Param("profession") String profession, @Param("className") String className, @Param("entranceTime") String entranceTime,
                              @Param("leaveTime") String leaveTime, @Param("employmentUnit") String employmentUnit, @Param("location") String location,
                              @Param("phoneNumber") String phoneNumber, @Param("email") String email, @Param("description") String description);
